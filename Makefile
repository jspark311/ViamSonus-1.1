...
MANUVROS_SRCS = src/ManuvrOS/*.cpp src/ManuvrOS/XenoSession/*.cpp src/ManuvrOS/ManuvrMsg/*.cpp src/ManuvrOS/Transports/*.cpp
...
CPP_SRCS += src/ManuvrOS/Drivers/ADCScanner/*.cpp src/ManuvrOS/Drivers/LightSensor/*.cpp
