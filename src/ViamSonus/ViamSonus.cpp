...
* Vanilla constructor.
*/
ViamSonus::ViamSonus() : EventReceiver() {
  setReceiverName("ViamSonus");
}
...
*/
int8_t ViamSonus::callback_proc(ManuvrRunnable *event) {
...
int8_t ViamSonus::notify(ManuvrRunnable *active_event) {
  int8_t return_value = 0;
